package com.geekworkx.hellocab.CropImage;

/**
 * Created by parag on 14/03/18.
 */
...
public class ImagePicker {
    ...
    private static Uri getImageUri(Activity activity, int resultCode, Intent imageReturnedIntent) {
        ...
        if (resultCode == Activity.RESULT_OK) {
          isCamera = (imageReturnedIntent == null ||imageReturnedIntent.getData() == null  || imageReturnedIntent.getData().equals(Uri.fromFile(imageFile)));
            if (isCamera) {     /** CAMERA **/
